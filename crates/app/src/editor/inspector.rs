    ...
    fn prop_control(
        ...
        match prop.ty {
            ...
            PropType::Text | PropType::MultilineText | PropType::Int | PropType::Float => {
                ...
                let ty = prop.ty;
                let field =
                    self.field(format!("{id}/{key}"), initial, cx, move |this, text, cx| {
                        let parsed = match ty {
                            PropType::Int => {
                                PropValue::Int(text.trim().parse().unwrap_or_default())
                            }
            ...
            PropType::Numbers => {
                let numbers = value
                    ...
                    .unwrap_or_default();
                let field =
                    self.field(format!("{id}/{key}"), numbers, cx, move |this, text, cx| {
    ...
    fn render_size(&mut self, id: NodeId, cx: &mut Context<Self>) -> AnyElement {
        ...
        if is_container {
            ...
            if style.layout == LayoutMode::Flow {
                ...
                blocks.push(labelled(
                    ...
                    chip_row(
                        ...
                        move |this, label, cx| {
                            ...
                            this.edit_style(id, "Justify", cx, move |style| {
                ...
                blocks
                    .push(self.switch_row(id, "Wrap", style.wrap, cx, |style, on| style.wrap = on));
            }
        }
                ...
                labelled(
                    ...
                    div()
                        ...
                        .child(SharedString::from(
                            spec.map(|spec| spec.title.to_string())
